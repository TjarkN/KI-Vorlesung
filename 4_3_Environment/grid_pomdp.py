    ...
    while True:
        ...
        for action in pomdp.actlist:
            for u in value_matxs:
                ...
                u1 = Matrix.matmul(Matrix.matmul(pomdp.transitions[action],
                                                 Matrix.multiply(pomdp.evidences[action], Matrix.transpose(u))),
                                   [[1], [1]])
                u1 = Matrix.add(Matrix.scalar_multiply(pomdp.gamma, Matrix.transpose(u1)), [pomdp.rewards[action]])
